...
**EECS @ UC Berkeley** · incoming AI/ML @ Walmart Global Tech · Cal Blueprint · Theta Tau
...
**ClearPath Medical** — Software Engineering Consultant
AI-powered PFMEA automation tool. Agentic pipeline that converts work instruction PDFs into FDA-compliant risk assessments, reducing analysis time by 85%. HIPAA-compliant, fully local processing.

**OptiGenix** — Software Engineering Intern
92.3% extraction accuracy on blood test PDFs using Vertex AI. HIPAA-compliant data workflows on GCP supporting 7,500+ monthly uploads.
...
**[gbrain](https://github.com/stephenhungg/gbrain)** — contributor to garrytan/gbrain
Patched the embedding pipeline with a sliding worker pool — 30x speedup (2 chunks/sec → 60 chunks/sec). PR merged into v0.9.1 community fix wave.
